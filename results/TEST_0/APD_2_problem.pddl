...
(:objects
    0.6,0.2,-0.1 0.8,0.0,-0.3 0.5,-0.3,-0.1 0.5,-0.3,-0.3 0.5,0.2,0.1 1.0,0.0,0.0 0.5,0.2,-0.1 0.5,0.2,-0.3 0.6,-0.3,0.0 0.6,0.2,0.0 - waypoint
...
(:init
    ...
    (gripper_at left_gripper 0.6,0.2,0.0)
)
