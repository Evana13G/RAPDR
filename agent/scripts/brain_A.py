...
def handle_trial(req):
    ...
    try:
        ...
        trialsTotalForTesting = 2

        while(goalAccomplished(goal, currentState.init) == False):
            trialsTotalForTesting = trialsTotalForTesting - 1
            ...
            #####################################################################################
                ...
                if newPrims == []:
                    print('No Primitives to Execute')
                    algoMode = 'APV' 
                else:
                # MODE 1: end
                # Pretty much, can remove this for MODE 2
                    ...
                    if gripperExecutionValidity == True:
                        if len(newPrims) == 1:
                            ...
                            actionToExecute = newPrims[actionIndex] 
                        print('Executing a Primitive' + actionToExecute.getName() + 'with gripper ' + str(actionToExecute.getGripper()))
